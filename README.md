...
><br>
><h1>수정해야 할 것</h1><br>
><ol><li>Mysql과 제대로 연동해서 기존 프로젝트처럼 정상적으로 작동 시키기.</li>
>    <li>기존 jsp에 쌩으로 추천음식 데이터를 넣는게 아닌 json형식으로 변경해서 관리보수 용이하게 할 것</li>
>    <li>유튜브 링크 간략화 시키기</li>
>    <li>로딩 속도 증가시킬 방법 찾아내기</li></ol>
>오늘은 학원 시험이고, 다음주 부터는 산업기사 실기 공부를 해야하므로 업데이트는 늦어질 예정, 틈틈히 시간날때 할 것 같다.
