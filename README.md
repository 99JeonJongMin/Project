...
><br>
><h1>수정해야 할 것</h1><br>
><ol><li>Mysql과 제대로 연동해서 기존 프로젝트처럼 정상적으로 작동 시키기. / 20250318 기존 mysql삭제 후 새로 작성하여 기존프로젝트처럼 작동 o </li>
>    <li>기존 jsp에 쌩으로 추천음식 데이터를 넣는게 아닌 db로 변경해서 관리보수 용이하게 할 것< / 20250318 menu table 생성 후 컨트롤러 맵퍼 서비스 추가시켜 기존처럼 동작 시키면서도 DB로 이전 성공 /li>
